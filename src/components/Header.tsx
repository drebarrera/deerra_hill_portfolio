...
export default function Header() {
    ...
    return <header className="fixed w-full z-[100] top-0 ">
        <div className="w-full h-[70px] px-[15px] md:px-[30px] bg-[#000000DD] flex flex-row justify-between items-center">
            <a href="/" className="text-3xl md:text-4xl" style={{ fontFamily: 'Oleo Script Swash Caps'}}>Déerra Hill</a>
        ...
        <nav className="w-full h-0 overflow-clip box-border px-[20px] pt-0 md:hidden flex flex-col gap-[10px] items-end bg-[#000000DD]" style={{height: navToggled ? "210px" : "0", transition: "height 1s"}}>
            <a href="/#about" className="decoration-0"><p className="text-lg font-semibold hover:underline underline-offset-4">About Me</p></a>
            <a href="/projects" className="decoration-0"><p className="text-lg font-semibold hover:underline underline-offset-4">Projects</p></a>
            <a href="/education" className="decoration-0"><p className="text-lg font-semibold hover:underline underline-offset-4">Education</p></a>
            <a href="/projects" className="decoration-0"><p className="text-lg font-semibold hover:underline underline-offset-4">Resume</p></a>
            <a href="/projects" className="relative decoration-0 w-fit h-fit">
