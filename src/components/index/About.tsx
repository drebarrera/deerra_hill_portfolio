...
export default function About() {
  return <section id="about" className="w-full h-fit py-[120px] px-[60px] flex justify-center items-center" style={{ background: "radial-gradient(#6E236E 0%, #111111 60%)" }}>
    ...
    <div className="w-full min-h-[400px] h-[full]" style={{ background: "url('/assets/index/deerra_hill.webp')", backgroundSize: "cover", backgroundPosition: "center" }}></div>
      <div className="w-full h-fit flex flex-col gap-[15px]">
        ...
        <a href="/education" className="relative decoration-0 w-fit h-fit">
          <div className={`text-base md:text-lg font-medium px-[16px] py-[3px] text-black ${styles.unicornButton}`} style={{ borderRadius: "20px" }}>Let's connect &rarr;</div>
        </a>
      </div>
    </div>
  </section>
