...
export default function About({ supertitle, title, subtitle, description, button_url, button_text, image }: {supertitle: string, title: string, subtitle: string, description: string, button_url: string, button_text: string, image: SanityImageType | undefined}) {
  return <section id="about" className="w-full h-fit py-[80px] md:py-[120px] px-[25px] md:px-[60px] flex justify-center items-center pb-[100px] md:pb-[300px]" style={{ background: "radial-gradient(#6E236E 0%, #111111 60%)" }}>
