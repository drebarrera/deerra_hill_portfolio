...
export default function Main({ supertitle, title, subtitle, image, carousel_title, carousel_projects, cta_caption, cta_button_text }: { supertitle: string, title: string, subtitle: string, image: SanityImageType | undefined, carousel_title: string, carousel_projects: CarouselItemType[] | undefined, cta_caption: string, cta_button_text: string  } ) {
